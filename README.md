...
Меня зовут Стебловский Антон, в недавнем прошлом я создал отдел контроля качества обработки клиентских запросов для одной известной IT компании. 

Вся система базировалась на связанных между собой гуглдоках с разным уровнем доступа. Цель системы  - ответ на простой вопрос, "какой уровень сервиса оказывает компания?" И тут меня осенило: "Хм... это же классная идея для веб-приложения!" - так и начался мой путь фронтендера! Я осознано выбрал его, потому что очень люблю визуализировать результат своей работы.
...
Стек: HTML5 / CSS3 /Sass / Next.js / TypeScript / Vite / Storybook / Git. 

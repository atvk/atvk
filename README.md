...
А потом меня осенило - "хм...  а это же классная идея для веб-приложения!" 

Так и начался мой путь фронтендера! я выбрал его  осознано, потому, что очень люблю визуализировать результат своей работы.
